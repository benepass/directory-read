...
class LazyObject:
    ...
    def new_method_proxy(func: Any):  # pyright: ignore [reportSelfClsParameterName]
        """
    ...
    )  # pyright: ignore [reportGeneralTypeIssues] # noqa: E501
...
def lazy(_func) -> Callable:
    def decorator(func) -> Any:
        @wraps(func)
        def wrapper(*args, **kw) -> Any:
            return LazyObject(lambda: func(*args, **kw))
